        ...
        <div class="flex justify-center">
            <div class="w-full max-w-md">
                <div class="bg-gray-200 shadow-lg rounded-lg p-8">
                    <h2 class="text-3xl font-bold text-center mb-6 text-gray-700">Sign In</h2>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex items-center justify-between">
                            <button type="submit" class="bg-blue-600 hover:bg-blue-800 text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600">Login</button>
                            <a href="{{ route('register') }}" class="text-sm font-semibold text-blue-600 hover:text-blue-800">Create an account</a>
                        </div>
                    </form>
                </div>
            </div>
